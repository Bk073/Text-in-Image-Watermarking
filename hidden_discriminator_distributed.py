...
#         pdb.set_trace()
#         print(w.shape)
        w = torch.reshape(w, (watermark.shape[0], -1, 256, 256))
...
class EndtoEnd(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx,  optimizer_idx):
        ...
        if optimizer_idx == 1:
            ...
            self.log("dis_loss_real", d_loss_on_cover, prog_bar=True)
            ...
            self.log("dis_loss_fake", d_loss_on_encoded, prog_bar=True)
        ...
        # if optimizer_idx == 1:
            ...
            loss = 0.7*loss_img + 2*loss_emb + 1e-1*loss_text + 1e-3*g_loss_adv
    ...
    def train_dataloader(self):
        ...
        loader = {"text_data": train_iter, "image_data":train_dataloader_img}
        return loader
...
def main():
    ...
    test_dir = '/home/bishwa/v-5/imagenette/test/'
    ...
    trainer = pl.Trainer(max_epochs=1, gpus=3)
    # trainer.fit(endtoend, zip(train_dataloader_img, train_iter), zip(val_dataloader_img, valid_iter))
